...
def convert_to_h264_aac_stream(input_path):
    """
    Convert the input video to H.264 (video) and AAC (audio) encoding using ffmpeg-python.
    ...
    try:
        print("Starting encoding and streaming with ffmpeg-python...")
        process = (
            ffmpeg
            .input(input_path)
            .output(
            ...
            .global_args('-loglevel', 'info')  # Change log level to 'info' for more details
        ...
        if request.method in ['GET', 'POST']:
            ...
            with tempfile.TemporaryDirectory() as tmpdirname:
                ...
                if video_type == 'mp3':
                    ...
                    filename = sanitize_filename(video_title) + ".mp4"
                    response = Response(
                        generate(),
                        mimetype='video/mp4',
                        headers={
